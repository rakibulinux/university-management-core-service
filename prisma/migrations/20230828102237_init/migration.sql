...
-- AddForeignKey
ALTER TABLE "offered_course_sections" ADD CONSTRAINT "offered_course_sections_offeredCourse_fkey" FOREIGN KEY ("offeredCourse") REFERENCES "offered_courses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
